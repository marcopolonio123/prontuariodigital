import type { MatchCandidate, Patient } from './types';

/* ------------------------------------------------------------------ */
/* Assinatura visual local: dHash 64-bit + distância de Hamming.       */
...
/* --------------------------- digital (demo) ------------------------ */
/* Web não expõe leitura biométrica de digitais; o sensor é simulado   */
/* localmente com template pseudoaleatório + qualidade de imobilidade. */
