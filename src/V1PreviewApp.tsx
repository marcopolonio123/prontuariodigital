...
export default function V1PreviewApp() {
  ...
  const createEvent = () => run(async () => {
    ...
    setEventTitle(''); setSymptoms(''); setDiagnosis(''); setExamsText(''); setPrescriptions(''); setNotes(''); setEditingEventId(null); setShowRecordForm(false); setMessage(editingEventId ? 'Registro atualizado com histórico preservado.' : 'Registro salvo com sucesso.');
  });
