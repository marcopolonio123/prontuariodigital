...
export default function V1PreviewApp() {
  ...
  const createEvent = () => run(async () => {
    ...
    setEventTitle(''); setNotes(''); setShowRecordForm(false); setMessage('Registro salvo com sucesso.');
  });
