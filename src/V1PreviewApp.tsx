...
export default function V1PreviewApp() {
  ...
  const createEvent = () => run(async () => {
    ...
    const created = await api.createHealthEvent(activeProfile.id, {
    ...
    setEventTitle(''); setSymptoms(''); setDiagnosis(''); setExamsText(''); setPrescriptions(''); setNotes(''); setShowRecordForm(false); setMessage('Registro salvo com sucesso.');
  });
