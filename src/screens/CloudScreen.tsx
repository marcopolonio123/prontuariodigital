  ...
  return (
    <div>
      <header className="rise mb-6">
        ...
        <h1 className="mt-1 font-display text-3xl font-bold tracking-tight text-ink">Nuvem My Doctor</h1>
        <p className="mt-1.5 max-w-2xl text-sm text-mute">
          ...
          com contas individuais e auditoria central. Sem conexão, o My Doctor segue funcionando 100% local.
        </p>
      </header>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          ...
          <section className="rise rounded-xl border border-line bg-card p-5 shadow-lift" style={{ animationDelay: '60ms' }}>
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h2 className="font-display text-lg font-bold text-ink">Servidor My Doctor oficial</h2>
