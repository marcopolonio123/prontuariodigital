...
export function SettingsScreen({
  ...
  const doExport = () => {
    ...
    a.href = url;
    a.download = `mydoctor-backup-${new Date().toISOString().slice(0, 10)}.json`;
    a.click();
  ...
  return (
    <div>
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <section className="rise rounded-xl border border-line bg-card p-5 shadow-lift">
          ...
          <p className="mt-2 text-sm leading-relaxed text-mute">
            Leve todo o My Doctor para outro dispositivo ou entregue o histórico a um médico em um único arquivo JSON.
          </p>
        ...
        <section className="rise rounded-xl border border-line bg-card p-5 shadow-lift" style={{ animationDelay: '140ms' }}>
          ...
          <p className="mt-2 text-sm leading-relaxed text-mute">
            Por decisão de produto, o My Doctor <strong className="text-ink">não permite excluir dados de saúde</strong>:
        ...
        <section className="rise rounded-xl border border-moss-500/30 bg-card p-5 shadow-lift lg:col-span-2" style={{ animationDelay: '160ms' }}>
          ...
          <p className="mt-2 max-w-3xl text-sm leading-relaxed text-mute">
            O My Doctor trata <strong className="text-ink">dados pessoais sensíveis de saúde</strong> (LGPD, art. 5º, II)
      ...
      <p className="rise mt-6 px-1 pb-4 font-mono text-[11px] text-mute" style={{ animationDelay: '180ms' }}>
        My Doctor v0.2.0 (mydoctor.med.br) — contas & acesso delegado · consultor IA · especialidades · retenção sem exclusão
      </p>
    </div>
  );
}
