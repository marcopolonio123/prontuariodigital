 ...
 * Como o Vitalis trata dados pessoais sensíveis de saúde (art. 5º, II),
      ...
      <div className="mx-auto max-w-3xl overflow-hidden rounded-xl border border-pine-700 bg-pine-900 shadow-float">
        ...
        <div className="px-4 py-3.5 sm:px-5">
          <p className="text-[13px] leading-relaxed text-pine-100">
            O Vitalis processa <strong className="text-white">dados pessoais sensíveis de saúde</strong> (alergias,
